...
export const ChatItem = ({ id, content, member, timestamp, fileUrl, deleted, currentMember, isUpdated, socketQuery, socketUrl }: ChatItemProps) => {
    ...
    const onMemberClick = () => {
        ...
        router.push(`/home/servers/${params?.serverId}/conversation/${member.id}`);
    ...
    const isAdmin = currentMember.MemberRoleId === "22192198-7307-4337-9f05-78703fc515b2";
    const isModerator = currentMember.MemberRoleId === "3119f7d1-d33b-4c8b-9b73-67be5cead272";
                ...
                <div className="flex flex-col w-full">
                    <div className="flex items-center gap-x-2">
                        <div className="flex items-center">
                            ...
                            <ActionTooltip label={member.MemberRoleId}>
                                {roleIconMap[member.MemberRoleId as keyof typeof roleIconMap]}
                            </ActionTooltip>
                        </div>
                    ...
                    {!fileUrl && isEditing && (
                        <Form {...form}>
                            ...
                            <span className="text-[10px] mt-1 text-zinc-400">
                                Pressione escape para cancelar e enter para salvar
                            </span>
                        </Form>
                    )}
                </div>
